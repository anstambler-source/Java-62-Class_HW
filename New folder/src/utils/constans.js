...
export const buttonsFooter = ['Send me email']
export const imgs = [friend1, friend2, friend3, friend4, friend5, friend6, friend7, friend8, friend9];
export const textParagraph = 'It is a period of civil war.\n' +
